...
void IFMapDependencyManager::Initialize() {
    ...
    ReactionMap react_li = map_list_of<string, PropagateList>
        (("logical-interface-virtual-machine-interface"), list_of("self"));
    policy->insert(make_pair("logical-interface", react_li));
