...
static bool IsTorDeleted(const PhysicalDeviceVnEntry *device_vn,
...
void MulticastHandler::HandleTorRoute(DBTablePartBase *partition,
                                      DBEntryBase *entry)
{
    PhysicalDeviceVnEntry *device_vn_entry =
...
void MulticastHandler::HandleTor(const VnEntry *vn) 
{
    ...
    walk_id = walker->WalkTable(agent_->device_manager()->
